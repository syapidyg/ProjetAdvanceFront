...
import { DELETE_REGLEMENT, READ_REGLEMENT, READ_ONE_REGLEMENT, READ_ONE_COMMANDE, READ_LIGNE_COMMANDE_CLIENT, READ_REGLEMENT_CLIENT, ETAT } from 'src/app/shared/_elements/api_constant';
...
@Component({
  selector: 'app-lister-reglement-client',
  templateUrl: './lister-reglement-client.component.html',
  styleUrls: ['./lister-reglement-client.component.scss']
})
export class ListerReglementClientComponent implements OnInit {
